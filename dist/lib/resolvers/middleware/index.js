...
exports.isOwnerRecipe = function (_, _a, input) {
    var id = _a.id;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, graphql_resolvers_1.skip];
            }
        });
    });
};
exports.isCategory = function (_, data) { return __awaiter(void 0, void 0, void 0, function () {
    var category;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, categoryStore_1.CategoryStore.findCategoryById(data.id)];
            case 1:
                category = _a.sent();
                if (!category) {
